...
ALTER TABLE `POKEMON_TEAM`CHANGE `SP_DEV_IV` `SP_DEF_IV` INT(2);
ALTER TABLE `POKEMON_TEAM`CHANGE `SP_DEV_EV` `SP_DEF_EV` INT(3);
ALTER TABLE `POKEMON_TEAM` ADD COLUMN `NATURE_ID` INT NOT NULL;
...
ALTER TABLE `POKEMON_TEAM` ADD CONSTRAINT `FK_POKEMON_TEAM_NATURE` FOREIGN KEY (`NATURE_ID`) REFERENCES `NATURE`(`ID`);
